...
function findRightHorizontally(widthFactor) {
  let product = 1;
  for (row = 0; row < 20; row++) {
    for (column = 0; column <= 20 - widthFactor; column++) {
      product =
        MATRIX[row][column] *
        MATRIX[row][column + widthFactor - 3] *
        MATRIX[row][column + widthFactor - 2] *
        MATRIX[row][column + widthFactor - 1];
      if (product > maxFactor) {
        maxFactor = product;
      }
      product = 1;
    }
...
function findDownVertically(widthFactor) {
  let product = 1;
  for (column = 0; column < 20; column++) {
    for (row = 0; row <= 20 - widthFactor; row++) {
      product =
        MATRIX[row][column] *
        MATRIX[row + widthFactor - 3][column] *
        MATRIX[row + widthFactor - 2][column] *
        MATRIX[row + widthFactor - 1][column];
      if (product > maxFactor) {
        maxFactor = product;
      }
      product = 1;
...
function findRightDiagonally(widthFactor) {
  let product = 1;
  for (row = 0; row <= 20 - widthFactor; row++) {
    for (column = 0; column <= 20 - widthFactor; column++) {
      product =
        MATRIX[row][column] *
        MATRIX[row + widthFactor - 3][column + widthFactor - 3] *
        MATRIX[row + widthFactor - 2][column + widthFactor - 2] *
        MATRIX[row + widthFactor - 1][column + widthFactor - 1];
      if (product > maxFactor) {
        maxFactor = product;
      }
      product = 1;
...
function findLeftDiagonally(widthFactor) {
  let product = 1;
  for (row = 0; row <= 20 - widthFactor; row++) {
    for (column = 19; column >= 0 + widthFactor - 1; column--) {
      product =
        MATRIX[row][column] *
        MATRIX[row + widthFactor - 3][column - (widthFactor - 3)] *
        MATRIX[row + widthFactor - 2][column - (widthFactor - 2)] *
...
findRightHorizontally(WIDTH_FACTOR);
findDownVertically(WIDTH_FACTOR);
findRightDiagonally(WIDTH_FACTOR);
findLeftDiagonally(WIDTH_FACTOR);
